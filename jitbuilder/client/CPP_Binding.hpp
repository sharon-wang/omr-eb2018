...
#if !defined(CPPBINDING_INCL)
#define CPPBINDING_INCL

#include "JitBuilderLanguageBinding.hpp"
#include "JitBuilderAPI.hpp"
#include "CPPFile.hpp"

class CPPBinding : public JitBuilderLanguageBinding
   {
public:
   CPPBinding(JitBuilderAPI & api, std::string directory)
