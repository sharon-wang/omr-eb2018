...
class UnionTypeDictionary : public TypeDictionary
   {
   public:
   UnionTypeDictionary() :
      TypeDictionary()
...
class SetUnionByteBuilder : public MethodBuilder
   {
   public:
   SetUnionByteBuilder(TypeDictionary *);
   virtual bool buildIL();
   };

class GetUnionByteBuilder : public MethodBuilder
   {
   public:
   GetUnionByteBuilder(TypeDictionary *);
   virtual bool buildIL();
   };

class SetUnionStrBuilder : public MethodBuilder
   {
   public:
   SetUnionStrBuilder(TypeDictionary *);
   virtual bool buildIL();
   };

class GetUnionStrBuilder : public MethodBuilder
   {
   public:
   GetUnionStrBuilder(TypeDictionary *);
   virtual bool buildIL();
   };

class TypePunInt32Int32Builder : public MethodBuilder
   {
   public:
   TypePunInt32Int32Builder(TypeDictionary *);
   virtual bool buildIL();
   };

class TypePunInt16DoubleBuilder : public MethodBuilder
   {
   public:
   TypePunInt16DoubleBuilder(TypeDictionary *);
   virtual bool buildIL();
   };
