...
MatMult::MatMult(TypeDictionary *types)
   : MethodBuilder(types)
   {
...
void
MatMult::Store2D(IlBuilder *bldr,
                 IlValue *base,
                 IlValue *first,
                 IlValue *second,
                 IlValue *N,
...
MatMult::buildIL()
   ...
   IlBuilder *iloop=NULL, *jloop=NULL, *kloop=NULL;
...
VectorMatMult::VectorMatMult(TypeDictionary *types)
   : MethodBuilder(types)
   {
   DefineLine(LINETOSTR(__LINE__));
   DefineFile(__FILE__);
...
void
VectorMatMult::VectorStore2D(IlBuilder *bldr,
                             IlValue *base,
                             IlValue *first,
                             IlValue *second,
                             IlValue *N,
...
IlValue *
VectorMatMult::VectorLoad2D(IlBuilder *bldr,
                            IlValue *base,
                            IlValue *first,
                            IlValue *second,
                            IlValue *N)
...
IlValue *
VectorMatMult::Load2D(IlBuilder *bldr,
                      IlValue *base,
                      IlValue *first,
                      IlValue *second,
                      IlValue *N)
