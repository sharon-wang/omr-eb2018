...
GetStructFieldAddressBuilder::GetStructFieldAddressBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
...
GetUnionFieldAddressBuilder::GetUnionFieldAddressBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineLine(LINETOSTR(__LINE__));
   DefineFile(__FILE__);
...
class StructTypeDictionary : public TypeDictionary
   {
   public:
