...
CreateStructArrayMethod::CreateStructArrayMethod(TypeDictionary *d)
   : MethodBuilder(d)
   {
...
ReadStructArrayMethod::ReadStructArrayMethod(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineLine(LINETOSTR(__LINE__));
   DefineFile(__FILE__);
...
class StructArrayTypeDictionary : public TypeDictionary
   {
   public:
