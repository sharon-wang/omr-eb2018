...
SetUnionByteBuilder::SetUnionByteBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineFile(__FILE__);
...
GetUnionByteBuilder::GetUnionByteBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineFile(__FILE__);
   DefineLine(LINETOSTR(__LINE__));
...
SetUnionStrBuilder::SetUnionStrBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineFile(__FILE__);
   DefineLine(LINETOSTR(__LINE__));
...
GetUnionStrBuilder::GetUnionStrBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineFile(__FILE__);
   DefineLine(LINETOSTR(__LINE__));
...
TypePunInt32Int32Builder::TypePunInt32Int32Builder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineLine(LINETOSTR(__LINE__));
   DefineFile(__FILE__);
...
TypePunInt16DoubleBuilder::TypePunInt16DoubleBuilder(TypeDictionary *d)
   : MethodBuilder(d)
   {
   DefineLine(LINETOSTR(__LINE__));
   DefineFile(__FILE__);
...
static Function assert_compile(MethodBuilder* m)
   {
   void* entry;
