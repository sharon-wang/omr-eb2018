...
int main(int argc, char *argv[])
   ...
   IlType *parmTypes_1s[] = { d.toIlType<int16_t>() };
   ThunkBuilder thunk1s(&d, "1s", NoType, 1, parmTypes_1s);
   ...
   IlType *parmTypes_1i[] = { d.toIlType<int32_t>() };
   ThunkBuilder thunk1i(&d, "1i", NoType, 1, parmTypes_1i);
   ...
   IlType *parmTypes_1l[] = { d.toIlType<int64_t>() };
   ThunkBuilder thunk1l(&d, "1l", NoType, 1, parmTypes_1l);
