...
class CreateStructArrayMethod : public MethodBuilder
   {
   private:
   ...
   public:
   CreateStructArrayMethod(TypeDictionary *);
   virtual bool buildIL();
   };

class ReadStructArrayMethod : public MethodBuilder
   {
   private:
   ...
   public:
   ReadStructArrayMethod(TypeDictionary *);
   virtual bool buildIL();
   };
